...
const PIPELINE_STAGE_MAP = {
  day_trading: {
    rsi_between_30_to_70_vol_5lcs_sma_gt_20_gt_50_gt_200: 'stage_0',
    ichimoku_swing_trading_5: 'stage_0',
    accumulation_distribution: 'stage_1',
    stocks_coming_out_of_base: 'stage_1',
    potential_breakout_152: 'stage_2',
    breakout_after_accumulation_like_tata_power: 'stage_2',
    accumulation_stocks: 'stage_3',
    stock_before_break_out: 'stage_3',
    base_pattern: 'stage_3',
    ready_to_breakout_shares: 'stage_3',
  },
  weekly_swing: {
    rising_price_and_volume_within_bollinger_band_and_rsi_70: 'stage_0',
    weekly_buy_find_trading_zones: 'stage_0',
    accumulation_stocks: 'stage_1',
    breakout_after_accumulation_like_tata_power: 'stage_1',
    zero_to_multibagger_rsi_above_50_on_weekly_chart: 'stage_1',
    potential_breakout_152: 'stage_2',
    bullish_stocks_screener_1: 'stage_2',
  },
};
